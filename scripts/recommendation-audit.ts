...
import type { RecommendationCandidate, RecommendationCostProfile, RecommendationItem, RecommendationMode, RecommendationProtocol } from '../shared/recommendation/types'

const base = (process.env.RECOMMENDATION_INDEXER_BASE ?? `https://lp-terminal.xyz/_chain/${CHAIN.key}`).replace(/\/+$/, '')
